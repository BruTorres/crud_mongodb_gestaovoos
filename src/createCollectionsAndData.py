...
LIST_OF_COLLECTIONS = ["TBL_AERONAVES", "TBL_VOOS "]
logger = logging.getLogger(name="crud_oracle_gestaovoos-main")
...
def extract_and_insert():
    ...
    for collection in LIST_OF_COLLECTIONS:
        ...
        if collection == "TBL_VOOS":
            df["DT_VOO"] = df["DT_VOO"].dt.strftime("%m-%d-%Y")
